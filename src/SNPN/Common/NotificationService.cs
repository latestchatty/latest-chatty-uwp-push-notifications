...
public class NotificationService : INotificationService
{
	...
	public NotificationService(AccessTokenManager accessTokenManager, IUserRepo userRepo, ILogger<NotificationService> logger, INetworkService networkService)
	{
	...
	private async Task ProcessNotificationQueue()
	{
		try
		{
			...
			{
				_logger.LogTrace("Processing notification queue.");
				try
				{
				...
				{
					_logger.LogError(ex, $"Exception in {nameof(ProcessNotificationQueue)}");
