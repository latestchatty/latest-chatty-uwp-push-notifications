...
(function() {
  var DirectoryExists, ProcessDirectory, ProcessUser, SendWP7Notification, SendWP7TileNotification, SendWP7ToastNotification, XML, apiBaseUrl, apiParentAuthorQuery, fs, http, jsxml, logPath, logger, path, rootPath, subscriptionDirectory, sys, url, winston;
  ...
  ProcessUser = function(userInfo) {
    ...
    return http.get(requestOptions, function(response) {
      ...
      return response.on('end', function() {
        var author, body, fileNameToSave, latestResult, newReplyCount, totalResults, totalResultsAttribute, xmlDoc;
