...
(function() {
  var RemoveRequest, SubscribeRequest, apiBaseUrl, apiParentAuthorQuery, fs, http, jsxml, localServicePort, logPath, logger, path, querystring, rootPath, subscriptionDirectory, sys, url, winston,
    _this = this;
