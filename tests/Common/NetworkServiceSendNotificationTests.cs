...
namespace SNPN.Test.Common
{
	public class NetworkServiceSendNotificationTests : NetworkServiceTestsBase
	{
		...
		async void SendNotificationBadgeTypeToast()
		{
			...
			var doc = NotificationBuilder.BuildReplyDoc(1, "Hello", "World");
			var result = await service.SendNotificationWNS(new QueuedNotificationItem(NotificationType.Toast, doc, It.IsAny<Post>(), It.IsAny<NotificationMatchType>(), "http://test.url"), "token");
		...
		async void SendNotificationBadgeTypeTile()
		{
			...
			var doc = NotificationBuilder.BuildReplyDoc(1, "Hello", "World");
			var result = await service.SendNotificationWNS(new QueuedNotificationItem(NotificationType.Tile, doc, It.IsAny<Post>(), It.IsAny<NotificationMatchType>(), "http://test.url"), "token");
		...
		async void SendNotificationBadgeTypeBadge()
		{
			...
			var doc = NotificationBuilder.BuildReplyDoc(1, "Hello", "World");
			var result = await service.SendNotificationWNS(new QueuedNotificationItem(NotificationType.Badge, doc, It.IsAny<Post>(), It.IsAny<NotificationMatchType>(), "http://test.url"), "token");
		...
		async void SendNotificationWithTag()
		{
			...
			var doc = NotificationBuilder.BuildReplyDoc(1, "Hello", "World");
			var result = await service.SendNotificationWNS(new QueuedNotificationItem(NotificationType.Toast, doc, It.IsAny<Post>(), It.IsAny<NotificationMatchType>(), "http://test.url", NotificationGroups.ReplyToUser, expected), "token");
		...
		async void SendNotificationWithTtl()
		{
			...
			var doc = NotificationBuilder.BuildReplyDoc(1, "Hello", "World");
			var result = await service.SendNotificationWNS(new QueuedNotificationItem(NotificationType.Toast, doc, It.IsAny<Post>(), It.IsAny<NotificationMatchType>(), "http://test.url", NotificationGroups.ReplyToUser, null, expected), "token");
